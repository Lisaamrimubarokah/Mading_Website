            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-lightblue">
                        ...
                        <!-- /.card-header -->
                        <?php echo form_open_multipart('hakAkses/update/' . $id_role, array('name' => 'formEdit')); ?>
                        <div class="card-body">
                                                    ...
                                                    <li class="d-inline-block me-2 mb-1">
                                                        <div class="form-check">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                value="<?= $v['id_menu'] ?>" 
                                                                <?php foreach ($hakAkses as $hk => $k) {                                                                                                                                          
                                                                if ($v['id_menu'] == $k['id_menu'])  echo "checked";} 
                                                                ?>>
                                                            </div>
                                                        </div>
                                                    </li>
                        ...
                        <div class="card-footer">
                            <button type="submit" name="simpan" class="btn btn-sm btn-info float-right">Edit</button>
