                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="matkul" placeholder="Mata Kuliah" id="matkul" type="text" class="form-control">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                            <!-- /.form-group -->
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="ruang_kelas" placeholder="Input Ruang Kelas" id="ruang_kelas" type="text" class="form-control">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                            <!-- /.form group -->
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="dosen" placeholder="Dosen Mata Kuliah" id="dosen" type="text" class="form-control">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                            <!-- /.form group -->
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="tanggal" placeholder="Input Tanggal" id="tanggal" type="date" class="form-control">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                            <!-- /.form group -->
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="jam_mulai" placeholder="Input Jam Mulai" id="jam_mulai" type="time" class="form-control">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                            <!-- /.form group -->
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="jam_selesai" placeholder="Input Jam Selesai" id="jam_selesai" type="time" class="form-control">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                            <!-- /.form group -->
