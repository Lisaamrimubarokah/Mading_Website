                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_role" id="id_role" class="form-control select2">
                                                    ...
                                                    <?php foreach ($role as $key => $value) { ?>
                                                        <option value="<?= $value['id_role'] ?>"><?= $value['id_role'] ?> - <?= $value['role'] ?></option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="username" placeholder="Input Username" id="username" type="text" class="form-control">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                            <!-- /.form group -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="email" placeholder="Email User" id="email" type="text" class="form-control">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                            <!-- /.form group -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="password" placeholder="Input Password" id="password" type="password" class="form-control">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                            <!-- /.form group -->
