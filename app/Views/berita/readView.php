                ...
                <div class="col-sm-12 col-md-9">
                    <div class="card">
                        <div class="card-body text-justify">
                            ...
                            <br>
                            <div>
                                <img class="img-fluid w-100 mb-5" src="<?= base_url('medberita/' . $berita['med_berita']); ?>" alt="Card image cap">
                            </div>
                            <div>
                                <p class="text-muted"><small> Dipublikasikan <?= $berita["created_at_berita"] ?></small></p>
                            </div>
                            <div>
                                <p class=""><?= $berita['desk_berita'] ?></p>
                            </div>
