                            ...
                            <table id="example1" class="table">
                                ...
                                <tbody>
                                    ...
                                    foreach ($pengumuman as $key => $value) { ?>
                                        <tr>
                                            <td><img width="200px" height="100px" src="<?= base_url('med_pengumuman/' . $value['medpengumuman']); ?>"></td>
                                            <td><b><?= $value['kategori_nama'] ?></b></td>
                                            <td>
                                                <a style="color: black;" href="<?= base_url('pengumuman/baca/' . $value['id_pengumuman']) ?>"><?= character_limiter($value['judul'], 50)  ?></a>
